...
public class GameManager : MonoBehaviour
{
    ...
    public int scoreThresholdSpeed = 2;
    
    public Spawner spawner;
    
    public TextMeshProUGUI highScoreListText;
    public TextMeshProUGUI highScoreTitel;
    public RawImage highScoreBG;
    ...
    public int Score
    {
        ...
        set
        {
            ...
            if (score >= scoreThreshold)
            {
                ...
                scoreThreshold *= scoreThresholdSpeed;
                level++;
    ...
    public void EndGame()
    {
        ...
        highScoreListText.gameObject.SetActive(true);
        highScoreTitel.gameObject.SetActive(true);
        highScoreBG.gameObject.SetActive(true);
        
        string highScoreDisplay = "";
        foreach (var scoreData in highScoreList)
        {
            highScoreDisplay += $"{scoreData.Key}: {scoreData.Value}\n";
        }
        highScoreListText.text = highScoreDisplay;
    }
    
    public void RestartGame()
    {
        click.GetComponent<AudioSource>().Play();
        highScoreTitel.gameObject.SetActive(false);
        highScoreBG.gameObject.SetActive(false);
